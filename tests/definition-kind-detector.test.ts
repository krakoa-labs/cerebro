...
describe("detectDefinitionKind — class (named lookup)", () => {
  it.each([
    ...
    expect(detectDefinitionKind(src, "Button.tsx", named)).toBe("class");
  });
...
describe("detectDefinitionKind — function (named lookup)", () => {
  it.each([
    ...
    expect(detectDefinitionKind(src, "Button.tsx", named)).toBe("function");
  });
...
describe("detectDefinitionKind — other (named lookup)", () => {
  it.each([
    ...
    expect(detectDefinitionKind(src, "Button.tsx", named)).toBe("other");
  });
...
describe("detectDefinitionKind — unanalyzed (named lookup)", () => {
  it.each([
    ...
    expect(detectDefinitionKind(src, "Button.tsx", named)).toBe("unanalyzed");
  });
});
...
describe("detectDefinitionKind — default lookup", () => {
  ...
  it.each([
    ...
    expect(detectDefinitionKind(src, "Button.tsx", dflt)).toBe("function");
  });
  ...
  it.each([
    ...
    expect(detectDefinitionKind(src, "Button.tsx", dflt)).toBe("class");
  });
  ...
  it("classifies a default-exported HOC call as other", () => {
    expect(detectDefinitionKind("export default connect()(Base);", "Button.tsx", dflt)).toBe(
      "other",
    );
  });
  ...
  it("returns unanalyzed when there is no default export", () => {
    ...
    expect(detectDefinitionKind(src, "Button.tsx", dflt)).toBe("unanalyzed");
  });
});
